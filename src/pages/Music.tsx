...
export default function Music() {
  return (
    <div className="flex-1 flex flex-col w-full bg-noir">
      ...
      <section id="stand-beside-us" className="w-full py-12 lg:py-16 px-6 lg:px-12 bg-noir scroll-mt-32">
        <div className="max-w-7xl mx-auto flex flex-col gap-8">
          <div className="flex flex-col gap-2 md:items-center md:text-center mb-2">
            <h2 className="text-[clamp(26px,3vw,34px)] font-display text-clean-white leading-[0.9] tracking-tighter">“Stand Beside Us”</h2>
      ...
      <section id="selected-credits" className="w-full py-16 lg:py-20 px-6 lg:px-12 bg-noir border-t border-graphite scroll-mt-32">
        <div className="max-w-7xl mx-auto flex flex-col gap-8">
          <h2 className="text-[clamp(26px,3vw,34px)] font-display text-clean-white leading-[1] tracking-tight">Selected Credits</h2>
      ...
      <section id="emotional-storytelling" className="w-full py-16 lg:py-24 px-6 lg:px-12 border-t border-graphite bg-noir scroll-mt-32">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          <div>
            <h3 className="text-[clamp(26px,3vw,40px)] font-display text-clean-white leading-[1.1] mb-8 tracking-tight">Emotional Storytelling</h3>
